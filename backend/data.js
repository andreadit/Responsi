...
const projects = [ { title: 'Website Pembelian Ticket ', image:'/img/demontix.png', 
description: 'Platform e-commerce dengan mudah saat kita ingin membeli tiket event di Yogyakarta.', tech: ['Vue.js', 'Laravel', 
'MySQL'], link: '#' }, 
  { title: 'Aplikasi Air Quality', image: '/img/oxyzone.png', 
description: 'Aplikasi yang memantau kualitas udara dan memberikan tips kesehatan serta informasi mengenai lokasi terdekat dengan kualitas udara lebih baik.', tech: ['C++', 'MySQL','Figma'], link: '#' }]; 
